...
export const routes: Routes = [
    ...
    { path: 'admin/feedback', loadComponent: () => import('./components/admin/feedback/admin-feedback.component').then(m => m.AdminFeedbackComponent), canActivate: [adminGuard] },
    { path: 'actions', loadComponent: () => import('./components/actions/actions.component').then(m => m.ActionsComponent), canActivate: [authGuard] },
